...
useradd usuario7 -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_SEC
useradd usuario8 -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_SEC
useradd usuario9 -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_SEC
